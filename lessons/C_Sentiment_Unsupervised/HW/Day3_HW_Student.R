...
# - There is a column called newsSite with sources cnn, fox-news, msnbc, the-american-conservative.  You may analyze each news source individually for your analysis (full credit) or individually as a single document set (-3 pts because its easiest)
